    ...
    <section>
      <div className="wrapper py-20 flex flex-col gap-10 lg:flex-row lg:items-center">
        <div className="flex flex-col items-center text-center gap-3 lg:w-[50%] lg:items-start lg:text-start">
          ...
          <h1 className="font-nunito font-black text-3xl sm:w-[500px] lg:w-auto lg:text-4xl">
            We are here to provide you with consistent satisfaction
          </h1>
          <p className="text-black/70 sm:w-[500px] lg:w-auto">
        ...
        <div className="grid gap-5 lg:w-[50%] md:w-[600px] md:mx-auto lg:mx-0">
          {data.map((item, index) => (
            ...
            >
              <div className="text-primary w-20 bg-primary/5 h-16 rounded-xl flex items-center justify-center text-3xl sm:w-28 sm:h-full">
                {item.icon}
              </div>
              <div className="w-full">
                <h1 className="text-lg font-nunito font-black text-black/90">
                  {item.title}
                </h1>
                <p className="text-black/70 md:w-[450px] lg:w-auto">
                  {item.description}
                </p>
              </div>
            </div>
